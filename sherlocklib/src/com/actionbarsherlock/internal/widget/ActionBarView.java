...
import com.actionbarsherlock.widget.MMTextView;
...
public class ActionBarView extends AbsActionBarView {
    ...
    private MMTextView mTitleView;
    private MMTextView mSubtitleView;
    ...
    private void initTitle() {
        if (mTitleLayout == null) {
            ...
            mTitleLayout = (LinearLayout) inflater.inflate(R.layout.abs__action_bar_title_item,
                    this, false);
            mTitleView = (MMTextView) mTitleLayout.findViewById(R.id.abs__action_bar_title);
            mSubtitleView = (MMTextView) mTitleLayout.findViewById(R.id.abs__action_bar_subtitle);
